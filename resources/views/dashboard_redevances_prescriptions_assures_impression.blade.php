    ...
    <div class="container" style="height:600px;margin-top:50px">
      ...
      <div class="row" style="margin-top:70px;margin-bottom:50px">
          <div style="border: 2px solid black" class="col-sm-5 col-sm-offset-6">
              <div class="row">
                <label class="control-label col-sm-4">Matricule</label>  
                <label class="control-label col-sm-6 dmatricule">45612</label>  

              </div>
              <div class="row">
                <label class="control-label col-sm-4">Nom(s)</label>  
                <label class="control-label col-sm-5 dnom">ANBOMO Jean calvin</label>  
              </div>
