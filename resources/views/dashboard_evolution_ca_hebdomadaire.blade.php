...
<div class="tab-content">
   <div class="row" style="margin-bottom:15px; margin-top:15px;">
      ...
      <div class="form-group">
          ...
          <label class="col-sm-1 control-label" >Mois <br> <span class="mois-validation validation-error"></label>
          <div class="col-sm-2">
  ...
  <table id="tabCAH" style="width:100%; heigth:60%" class="table table-striped table-responsive blockMe">
           <caption id="cap">
              <h4 class="text-center" style="color:rgb(51,122,183); font-weight: bold;">CHIFFRE D'AFFAIRE HEBDOMADAIRE</h4>
          </caption>   
...
$('#tabCAH').DataTable({
                ...
                { className: "align-center","targets": [3,4]}
              ],
                dom: 'Blfrtip',
                buttons: [
                        {
                          ...
                          className: 'btnExcel',
                          title : "EVOLUTION CHIFFRE D'AFFAIRE HEBDOMADAIRE"
                        }
    ...
    $(".dataTables_filter input").addClass("form-control");
     ...
     function formatMoney(num , localize,fixedDecimalLength){
      ...
      if(validate()){
               $.ajax({
                        url: "{{route('dashboard_evolution_ca_hebdomadaire_get')}}",
                        dataType: "json",
                        data: {
                    ...
                    .done(function(msg){
                              ...
                              $("#total").val(formatMoney(JSON.parse(msg['total'])));
                               for(i=0;i < tab.length;i++){
                                ...
                                var rowIndex = $('#tabCAH').dataTable().fnAddData(data);
                                var row = $('#tabCAH').dataTable().fnGetNodes(rowIndex);
                                $(row).attr( 'id','item' + i); 
                                var tr = $("#tabCAH tr#item"+i);
                               ...
                               if($("#tabCAH").dataTable().fnSettings().aoData.length===0) {
     ...
     $('#btnPrint').click(function(){
            ...
            window.open("{{ route('dashboard_evolution_ca_hebdomadaire_impression') }}?annee="+$("#annee").val()+"&mois="+$("#mois").val());
    });
@endsection