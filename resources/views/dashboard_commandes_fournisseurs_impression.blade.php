...
@section('Slider')
  ...
  <div class="container" style="margin:40px;">
    ...
    <div class="container" style="height:600px;margin-top:50px">
      ...
      <h3 class="text-center" style="text-decoration:underline;color:blue">ETAT DES COMMANDES PAR FOURNISSEUR <span class="dnom_four"></span></h3>
      <h3 class="text-center" style="text-decoration:underline;color:red">Mois de <span class="dmois">Janvier</span> <span class="dannee">2017</span></h3>
      <div style="margin-top:70px;">
      <h3 class="text-left dlibelle_assureur" style="text-decoration:underline">BIO-HOSFRO</h3>
      <div class="table">
          ...
          <tfoot>
               <th class="text-center" colspan="4" style="color:red;font-size:1.4em">TOTAL</th>
      ...
      <div class="row" style="margin-top:30px">
          <div class="form-group">
            <label style="color:red;font-size:1.5em" class="col-sm-4 col-sm-offset-2 control-label"> TOTAL COMMANDES (F CFA): </label>
            <div class="col-sm-5">
              <input class="form-control" type="number" id="montant_total">
            </div>
          </div>
