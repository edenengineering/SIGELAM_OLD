...
<div class="tab-content">
  ...
  <table id="tabFA" style="width:100%; heigth:60%" class="table table-striped table-responsive">
           <caption id="cap">
              <h4 class="text-center" style="color:rgb(51,122,183); font-weight: bold;">FACTURE RECAPITULATIVE ASSUREUR</h4>
          </caption>   
          ...
          <tfoot>
              ...
              <th><input type="number" class="form-control" id="Tticket"> </th>
  ...
  $('#tabFA').DataTable({
    ...
    $(".dataTables_filter input").addClass("form-control");
     ...
     $('#btnPrint').click(function(){
            ...
            window.open("{{ route('dashboard_facture_assureur_impression') }}");
    });
@endsection