...
<div class="tab-content">
               <legend> <h4 class="text-left" style="color:rgb(51,122,183); font-weight: bold;">STATISTIQUE DES PATHOLOGIES PAR TRANCHE D'AGE</h4></legend>

   <div class="row" style="margin-bottom:15px; padding-top:10px;margin-top:15px; height: 200px;border-radius:10px;background-color:rgb(238, 247, 240);">
            <div class="col-sm-5">
              <div class="row" style="">
                <div class="col-sm-6">
            ...
            <div class="col-sm-3">
             ...
             <div class="row">
                 <div class="form-group">
                   <label for="TR" class="control-label col-sm-8 text-left" style="" >Type resultats : <br /><span class="TR-validation validation-error"></span></label>
...
function getExportFileName(){
 ...
 return "STATISTIQUEDES PATHOLOGIES PAR TRANCHE D'AGE " + $("#analyse option:selected").text();
}
var table =  $('#tabSP').DataTable({
    ...
    $(".dt-button buttons-excel").addClass("btn btn-success");
     ...
     $("#btnPrint").click(function(){
           ...
           window.open("{{ route('dashboard_print_stat_tranche_age') }}?date_debut="+$("#du").val()+"&date_fin="+$("#au").val()+"&genre="+$("#genre").val()+"&examen="+$("#analyse").val()+"&rendu="+$("#element").val()+"&resultats[]="+ tab +"&age_min="+ $("#age_min").val()+"&age_max="+ $("#age_max").val());
     ...
     $("#btnOK").click(function(){
       ...
       $('#tabSP').dataTable().fnClearTable();
            ...
            $("#TR option:selected").each(function () {
             ...
             $.ajax({
                            url: "{{route('dashboard_get_statistique_pathologie_age')}}",
                            dataType: "json",
                            type: "get",
                             beforeSend: function(){
                                     $('.blockMe').block({ 
                        ...
                        complete: function(){
                            ...
                            data: { 
                                      ...
                                      'genre': $("#genre").val(),
                                      'examen' : $("#analyse").val(),
                                      'rendu' : $("#element option:selected").text(),
                                      'resultats' : tab,
                              }
