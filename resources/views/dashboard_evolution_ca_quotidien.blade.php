...
<div class="tab-content">
   <div class="row" style="margin-bottom:15px; margin-top:15px;">
      ...
      <div class="form-group">
           <label class="col-sm-1 control-label" >Date <br> <span class="date-validation validation-error"> </label>
          <div class="col-sm-3">
              <input class="form-control" type="date" name="date" min="0" id="date">
          </div>
          <div class="col-sm-1">
  ...
  <table id="tabCAQ" style="width:100%; heigth:60%" class="table table-striped table-responsive blockMe">
           <caption id="cap">
              <h4 class="text-center" style="color:rgb(51,122,183); font-weight: bold;">CHIFFRE D'AFFAIRE QUOTIDIEN</h4>
          </caption>   
...
$('#tabCAQ').DataTable({
                ...
                buttons: [
                        {
                          ...
                          className: 'btnExcel',
                          title : "EVOLUTION CHIFFRE D'AFFAIRE QUOTIDIEN"
                        }
  ...
  function formatMoney(num , localize,fixedDecimalLength){
      ...
      if(validate()){
               $.ajax({
                        url: "{{route('dashboard_evolution_ca_quotidien_get')}}",
                        dataType: "json",
                        data: {
     ...
     $('#btnPrint').click(function(){
            ...
            window.open("{{ route('dashboard_evolution_ca_quotidien_impression') }}?date="+$("#date").val());
    });
@endsection