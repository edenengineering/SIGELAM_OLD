...
@section('Slider')
  ...
  <div class="container" style="margin:40px;">
    ...
    <div class="container" style="height:600px;margin-top:50px">
      ...
      <h3 class="text-center" style="text-decoration:underline">RECAPITULATIF IMPAYES PARTENAIRES <span class="dnom_four"></span></h3>
      ...
      <div class="row" style="margin-top:30px">
          <h3>Arrêté le présent récapitulatif à la somme de : <span class="dmontant_total" style="font-weight:bold">vingt cinq millions</span></h3>  
