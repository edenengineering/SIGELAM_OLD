...
<div class="table-responsive">
  <table id="tabIP" style="width:100%; heigth:60%" class="table table-striped ">
           <caption id="cap">
              <h4 class="text-center" style="color:rgb(51,122,183); font-weight: bold;">IMPAYES PARTENAIRES</h4>
          </caption>   
...
$('#tabIP').DataTable({
    ...
    $('#btnPrint').click(function(){
            ...
            window.open("{{ route('dashboard_impayes_partenaires_impression') }}");
    });
@endsection