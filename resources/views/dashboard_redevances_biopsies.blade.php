...
<div class="tab-content">
  ...
  <table id="tabRB" style="width:100%; heigth:60%" class="table table-striped table-responsive">
           <caption id="cap">
              <h4 class="text-center" style="color:rgb(51,122,183); font-weight: bold;">REDEVANCES BIOPSIES</h4>
          </caption>   
...
$('#tabRB').DataTable({
    ...
    $(".dataTables_filter input").addClass("form-control");
     ...
     $('#btnPrint').click(function(){
            ...
            window.open("{{ route('dashboard_redevances_biopsies_impression') }}");
    });
@endsection