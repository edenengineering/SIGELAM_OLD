...
<div class="tab-content">
   <div class="row" style="margin-bottom:15px; margin-top:15px;">
    ...
    <div class="row" style="margin-bottom:15px; margin-top:15px;">
      ...
      <div class="form-group">
          ...
          <label class="col-sm-1 control-label" >Medecin</label>
          <div class="col-sm-3">
  ...
  <table id="tabRCP" style="width:100%; heigth:60%" class="table table-striped table-responsive">
           <caption id="cap">
              <h4 class="text-center" style="color:rgb(51,122,183); font-weight: bold;">REDEVANCES CENTRE PRESCRIPTEUR</h4>
          </caption>   
          ...
          <thead style="background-color: LightSlateGray; color:white;  -webkit-box-shadow: 0px -4px 3px rgba(50, 50, 50, 0.75);-moz-box-shadow:    0px -4px 3px rgba(50, 50, 50, 0.75);box-shadow:0px -4px 3px rgba(50, 50, 50, 0.75);">
            <tr  style ="heigth:10px;">
              ...
              <th class="text-left">Centre prescripteur</th>
...
$('#tabRCP').DataTable({
    ...
    $(".dataTables_filter input").addClass("form-control");
     ...
     $('#btnPrint').click(function(){
            ...
            window.open("{{ route('dashboard_redevances_centre_prescripteur_impression') }}");
    });
@endsection