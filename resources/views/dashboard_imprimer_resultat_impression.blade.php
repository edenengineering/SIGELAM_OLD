  ...
  <div class="container" style="margin:40px;">
          ...
          <div class="row" style="padding-bottom:0; margin-bottom:20px; border-bottom: 2px solid green">
              ...
              <div class="col-sm-8 text-left" style="padding-top:0  ">
                   <h2 class="text-center" style="text-decoration:underline">CENTRE D'ANIMATION SOCIALE ET SANITAIRE</h2>
                  <h4 class="text-center" style="font-weight:bold">Centre Médical Mgr Jean Zoa</h4>
                  <h4 class="text-center" style="font-style:italic">HEMATOLOGIE - BIOCHIMIE - BACTERIOLOGIE - IMMUNOLOGIE - IMMUNO-BACTOR - SEROLOGIE A - SEROLOGIE B - SEROLOGIE HIV</h4>
                  <h5 class="text-center">BP 185 Yaoundé-Cameroun Téléphone : (+237) 222 220 403 </h5>
                  <h5 class="text-center"> Email: cassnkolndongo@yahoo.fr</h5>
                  <h5 class="text-center" style="font-weight:bold;color:red">Situé à Nkolndongo </h5>
              </div>
              <div class="col-sm-2 text-left" style="width:150px; padding-left:30px; padding-top:5px">
                   <img src="{{ URL::asset('logo2.jpg') }}" style="height:100px;" class="img-responsive" alt="Logo Gelam">
              </div>
      ...
      <div class="table-responsive ">
          <table class="table table-bordered" style="font-size:1.2em">
            <thead>
              ...
              <tr>
                <th colspan="6" class="dlibelle_groupe_examen text-center">EXAMEN SEROLOGIQUE</th>
              </tr>
              <tr>
